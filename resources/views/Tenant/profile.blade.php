...
<div class="content d-flex">
          ...
          <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .491.592l-1.5 8A.5.5 0 0 1 13 12H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"/>
              ...
              <li>
                <a href="/tenant/profile" class="nav-link active">
        ...
        <div class="value" style="margin-left:329px;margin-top:25px;padding:0px;flex: 1 0 auto;">
            <div class="head" style="margin-bottom: 36px;">
                <div class="title">
                    <Strong style="font-size: 32px;">Profile</Strong>
                </div>
            </div>

            <div class="content-menu d-flex">
                <div class="profile-picture">
                    <img src="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png" alt="" style="width: 185px;border-radius: 513.889px;">
                </div>

                <div class="profile-desc mt-2" style="width: 619px;height: 162px;background: #EDFCF2;margin-left:40px;padding:10px 20px 10px 20px">
                    <h5>Warung Moy</h5>

                    <div class="tlp d-flex gap-3" style="margin-top:20px;">
                    <div class="label-tlp">
                        <p style="font-weight: 500;font-size: 16px;">No Telp : </p>
                    </div>
                    <div class="value">
                        <p style="font-weight: 500;font-size: 16px;">087927381092</p>
                    </div>
                    </div>

                    <div class="email d-flex gap-3">
                    <div class="label-email">
                        <p style="font-weight: 500;font-size: 16px;">Email : </p>
                    </div>
                    <div class="value">
                        <p style="font-weight: 500;font-size: 16px;">wlwlw@gmail.com</p>
                    </div>
                    </div>

                    <div class="button-dit">
