...
<nav style="height:90px; background-color:#FFFFFF; box-shadow: 0px -20px 30px rgba(0, 0, 0, 0.1);" class="navbar navbar-expand navbar-light fixed-bottom">
      <div class="container-fluid">
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul style="margin-top:20px" class="navbar-nav nav-justified w-100">
            ...
            <li class="nav-item">
                <div class="pesanan">
                <a href="/pesanan/{{$id_cart_integer}}/{{$id_tenant}}" style="text-decoration-line: none; color:black">
    ...
    <div class="container d-flex justify-content-center">
        <div class="category d-flex gap-2" style="margin-top: 80px; width:136px; height:36px; background-color:#F2F4F7; padding: 4px 8px 4px; border-radius:16px">
            <div class="category-food d-flex justify-content-center" style="width:54px; height:28px; background-color:#F2F4F7; border-radius:13.28px;font-size:12px; padding: 6px 7.91px 6px 7.91px">
                <a style="text-decoration:none; color:#98A2B3;" href="/order/{{$id_cart_integer}}/foods/{{$id_tenant}}">Foods</a>
            </div>
            <div class="category-drinks d-flex justify-content-center" style="width:100%; height:28px; background-color:#16B364; border-radius:13.28px; color:white; font-size:12px; padding: 6px 7.91px 6px 7.91px">
                <a style="text-decoration:none; color:white;" href="/order/{{$id_cart_integer}}/drinks/{{$id_tenant}}">Drinks</a>
            </div>
        </div>
    </div>
    ...
    <div class="container d-flex justify-content-center">
        ...
        <div class="search" style="margin-top: 24px; width:100%;">
            <form action="/order/{{$id_cart_integer}}/search/drink/{{$id_tenant}}/result" method="post">
                @csrf
